...
var _moarwick$elm_webpack_starter$Test$maybeBindTest = function (a) {
	return (_elm_lang$core$Native_Utils.cmp(a, 3) > 0) ? _elm_lang$core$Maybe$Just(a) : _elm_lang$core$Maybe$Nothing;
};
var _moarwick$elm_webpack_starter$Test$maybeTest = function (a) {
	return _elm_lang$core$Maybe$Just(a);
};
...
var _moarwick$elm_webpack_starter$Main$styles = {
	img: {
		...
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'border', _1: '4px solid #337AB7'},
			_1: {ctor: '[]'}
		}
	}
};
var _moarwick$elm_webpack_starter$Main$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			default:
				var _p1 = _elm_lang$core$Debug$log('fdafds');
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
					{ctor: '[]'});
...
var _moarwick$elm_webpack_starter$Main$model = {
	counter: 0,
	ids: {ctor: '[]'}
};
var _moarwick$elm_webpack_starter$Main$Model = F2(
	function (a, b) {
		return {counter: a, ids: b};
	});
...
var _moarwick$elm_webpack_starter$Main$GotStories = {ctor: 'GotStories'};
var _moarwick$elm_webpack_starter$Main$GetStories = {ctor: 'GetStories'};
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_moarwick$elm_webpack_starter$Main$GetStories),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
